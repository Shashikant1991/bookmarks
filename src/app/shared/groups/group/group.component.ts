...
import {GroupsReorderCardsAction} from '../../../states/editor/groups/groups-reorder-cards.action';
...
export class GroupComponent implements OnDestroy, OnInit, AfterViewInit {
    ...
    public set groupId(groupId: EntityIdType) {
        this.group$ = this._store.select(GroupsState.byId).pipe(map(selector => selector(groupId)));
    }
